    ...
    <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-xl font-black text-white">
              {editingBarberId ? "Editar barbero" : "Agregar nuevo barbero"}
            </h3>
          </div>
        </div>
      ...
      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
        <button
          ...
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-purple-600 px-6 py-3 font-semibold text-white transition hover:bg-purple-500 disabled:opacity-60"
        >
          {loadingSave ? (
            <>
              <Loader2 className="animate-spin" size={18} />
      ...
      <div className="mt-8">
        <h4 className="mb-4 font-bold text-white">Barberos activos</h4>
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-full border border-purple-500/40 px-4 py-2 text-sm font-semibold text-purple-300 transition hover:bg-purple-500/10"
                    >
                      <Edit3 size={16} />
                      Editar
                    </button>
