  ...
  return (
    <>
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white text-zinc-950 shadow-2xl shadow-black/40 transition hover:scale-105 hover:bg-zinc-200"
